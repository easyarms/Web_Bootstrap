...
<header class="d-flex flex-nowrap">
    ...
    <body>
    <span class="placeholder col-00 placeholder-lg"></span>
    <div class="pricing-header p-3 pb-md-4 text-center">
        ...
        <main>
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 g-2">
                ...
                <div class="card" style="width: 30rem;">
                    <h2 class="display-9 fw-normal">Наши контакты</h2>
                    <p class="fs-10 text-body-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed
                        do eiusmod
                        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
                        veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                        commodo conseguat. Duis aute irre dolor in reprehenderit in voluptate velit esse cillum
                        dolore e fugiat nulla pariatur. Excepteur sint occaecat
                        cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id
                        est laborum. While these feedback styles cannot be styled with CSS, you can still
